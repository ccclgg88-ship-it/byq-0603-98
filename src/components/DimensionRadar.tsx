  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-semibold text-pink-200 tracking-wide">维度雷达图</h3>
        ...
        {dimensions.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart data={data} cx="50%" cy="50%" outerRadius="75%">
              ...
              <PolarAngleAxis
                dataKey="dimension"
                tick={{ fill: '#E879F9', fontSize: 12, fontWeight: 500 }}
                tickLine={false}
              />
              <PolarRadiusAxis
                angle={30}
              ...
              <Radar
                ...
                stroke="#FF6B9D"
                strokeWidth={2}
                fill={hasScores ? 'url(#radarGradient)' : 'rgba(255,107,157,0.1)'}
                fillOpacity={hasScores ? 0.6 : 0.2}
              ...
              <Tooltip
                ...
                labelStyle={{ color: '#E879F9', marginBottom: '4px' }}
              />
            </RadarChart>
          </ResponsiveContainer>
        ) : (
